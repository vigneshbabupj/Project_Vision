...
def train(plane_args,yolo_args,midas_args,add_plane_loss,add_yolo_loss,add_midas_loss):
    ...
    ## END yolo train setup 
        ...
        for i,(plane_data,yolo_data,depth_data) in pbar:
            ...
            plane_inp = dict(input = [images, image_metas, gt_class_ids, gt_boxes, gt_masks, gt_parameters, camera], mode='inference_detection', use_nms=2, use_refinement=True, return_feature_map=True)
