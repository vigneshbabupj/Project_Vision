...
import RoIAlign.roi_align_folder.crop_and_resize_cpu as crop_and_resize_cpu
if torch.cuda.is_available():
    import RoIAlign.roi_align_folder.crop_and_resize_gpu as crop_and_resize_gpu


#Vignesh : Start Replace with the function from the planercnn
'''
...
'''
#Vignesh : End Replace with the function from the planercnn
